    ...
    >
        <div class="text-center mb-10 p-6 rounded-lg">
            <p
                :class="[
                    'text-lg font-medium',
                    appStore.settings.displayMode === DISPLAY_MODE.DARK ? 'text-gray-200' : 'text-gray-700'
                ]"
            >
            ...
            <div v-if="autoUpdateStore.showUpdateUI" class="mt-6 space-y-4">
                ...
                <p
                    class="text-sm"
                    :class="appStore.settings.displayMode === DISPLAY_MODE.DARK ? 'text-blue-300' : 'text-blue-600'"
                >
