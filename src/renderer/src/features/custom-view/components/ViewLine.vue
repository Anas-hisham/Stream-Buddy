<template>
    <div
      ...
      :class="[
        appStore.settings.displayMode === DISPLAY_MODE.DARK ? 'border-white' : 'border-black',
    ...
    >
      <div v-if="line.fields.length > 0" class="absolute left-2 top-1/2">
        <i
          ...
          :class="appStore.settings.displayMode === DISPLAY_MODE.DARK ? 'text-gray-400' : 'text-gray-500'"
        ></i>
      </div>
