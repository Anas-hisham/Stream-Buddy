  ...
  >
    <div class="flex justify-center items-center h-[calc(100vh-60px)] fixed">
      ...
      <div data-aos="fade-right " data-aos-offset="0">
        <ul class="space-y-1 px-2" :class="appStore.visibleViews.length > 7 ? 'mb-20' : 'mb-0'">
          <li v-for="view in appStore.visibleViews" :key="view.path" class="">
            <div v-if="viewNotInSideNav(view.path)">
              ...
              >
                <span v-if="appStore.settings.navMode === 'full'" class="ml-3 font-medium">
                  {{ view.title }}
                </span>
                <span
                  v-else
          ...
          <li class="builder pt-4">
            <router-link
              ...
              :class="[
                ...
                'hover:shadow-md',
                appStore.settings.navMode === 'full' ? 'justify-start' : 'justify-center',
                appStore.isDarkMode ? ' text-green-400' : 'hover:bg-gray-50 text-green-600',
            ...
            >
              <div
                ...
                "
              >
                <i class="pi pi-plus transition-all duration-300 group-hover:scale-125"></i>
              </div>
              <span class="ml-2 font-medium" v-if="appStore.settings.navMode === 'full'"
                >New View</span
              >
            </router-link>
          </li>
