        ...
        >
          <div class="flex items-center justify-between gap-3">
            <div class="flex items-center gap-2 min-w-0 flex-grow">
              ...
              <template v-else>
                <button
                  @click="settingsStore.applyPresetFromButton(preset.name, showAlert)"
            ...
            <div class="flex gap-2 flex-shrink-0">
              ...
              <template v-if="settingsStore.updatingPreset === preset.name">
                <button
                  @click="settingsStore.confirmUpdatePreset(preset.name, showAlert)"
          ...
          <div
            ...
            :class="
              appStore.settings.displayMode === 'dark' ? 'border-gray-500/50' : 'border-gray-200'
            "
          >
              ...
              <div v-if="view.title !== 'Settings'" class="flex items-center justify-between">
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                  ...
                  <div
                    ...
                    :class="appStore.settings.displayMode === 'dark' ? 'bg-gray-500' : ''"
                  ></div>
                </label>
              </div>
            </template>
