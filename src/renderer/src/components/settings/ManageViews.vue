      ...
      <div class="bg-opacity-50 py-4 rounded">
        <template v-for="(view, index) in views" :key="index">
          <div
            ...
            :class="displayMode === 'dark' ? ' hover:bg-gray-600' : '  hover:bg-gray-100'"
          >
            ...
            <div class="flex items-center space-x-4">
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" v-model="views[index].visible" class="sr-only peer" />
                <div
...
const withoutEditButton = (path) => {
  const without =
    path !== '/settings' && path !== '/brackets-view' && path !== '/players-stats' && path !== "/today's-matches"
  return without
}
