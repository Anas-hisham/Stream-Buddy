<template>
    ...
    >
        ...
        <div class="center-center h-[calc(100vh-60px)] fixed">
            ...
            <div class="flex flex-col items-start" v-if="isBuilder">
                <FieldTypesPalette />
                <SectionTypesPalette />
            </div>
                ...
                >
                    <li v-for="view in appStore.visibleViews" :key="view.path" class="">
                        <div v-if="viewTemplates(view.path)">
                            <router-link
                                ...
                                :title="
                                    appStore.settings.navMode === NAV_MODE.MINI ? view.title : ''
                                "
                            >
                                <span
                                    v-if="appStore.settings.navMode === NAV_MODE.FULL"
                    ...
                    <li class="builder pt-4">
                        <router-link
                            ...
                            :title="appStore.settings.navMode === NAV_MODE.MINI ? 'New View' : ''"
                        >
                            <div
            ...
            <div class="settings absolute bottom-5 pt-2 border-t border-zinc-500">
                <div data-aos="fade-right" data-aos-offset="0">
                    <router-link
                        ...
                        :title="appStore.settings.navMode === NAV_MODE.MINI ? TITLES.SETTINGS : ''"
